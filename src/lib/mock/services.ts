 ...
 * in the shared database (see src/lib/db/) and is initialised from
...
export const FREYR_SERVICES: FreyrService[] = [
  svc({
    ...
    relevantCompanySignals: ["global", "enterprise", "broad portfolio", "multiple markets", "upcoming submission", "late-stage program", "multi-region trials", "post-approval", "cell therapy", "gene therapy"],
  ...
  svc({
    ...
    relevantCompanySignals: ["oncology", "cell therapy", "pipeline", "new modality", "pivot", "phase 1 program", "phase 2 program", "trial start", "gene therapy", "late-stage program"],
  ...
  svc({
    ...
    relevantCompanySignals: ["high submission volume", "m&a", "integration", "enterprise", "global", "active clinical pipeline", "large clinical pipeline", "upcoming submission"],
  ...
  svc({
    ...
    relevantCompanySignals: ["pipeline", "multi-product", "launches", "scaling", "upcoming submission", "late-stage program", "phase 3 program", "post-approval", "product launch", "active clinical pipeline"],
  ...
  svc({
    ...
    relevantCompanySignals: ["high submission volume", "launches", "upcoming submission", "late-stage program"],
  ...
  svc({
    ...
    relevantCompanySignals: ["broad portfolio", "global", "many markets", "multiple products", "post-approval", "product launch", "multi-region trials"],
  ...
  svc({
    ...
    relevantCompanySignals: ["m&a", "integration", "digital transformation", "data silos", "active clinical pipeline", "upcoming submission", "post-approval"],
  ...
  svc({
    ...
    relevantCompanySignals: ["oncology", "complex filings", "pipeline", "upcoming submission", "late-stage program", "phase 3 program"],
  ...
  svc({
    ...
    relevantCompanySignals: ["marketed portfolio", "launches", "new modality", "cell therapy", "post-approval", "product launch", "approved products", "pharmaceutical", "biologic"],
  ...
  svc({
    ...
    relevantCompanySignals: ["marketed portfolio", "launches", "post-approval", "product launch"],
    relatedServices: ["pv"],
  ...
  svc({
    ...
    relevantCompanySignals: ["launches", "new markets", "specialty", "post-approval", "product launch"],
    relatedServices: ["reg-strategy"],
  ...
  svc({
    ...
    relevantCompanySignals: ["manufacturing", "device", "warning letter", "integration", "global sites", "recall", "compliance pressure", "device launch"],
  ...
  svc({
    ...
    relevantCompanySignals: ["manufacturing", "global sites", "warning letter", "recall", "compliance pressure"],
  ...
  svc({
    ...
    relevantCompanySignals: ["device", "connected", "digital", "software", "samd", "recall", "compliance pressure"],
  ...
  svc({
    ...
    relevantCompanySignals: ["integration", "global sites", "recall", "compliance pressure"],
  ...
  svc({
    ...
    relevantCompanySignals: ["manufacturing", "integration", "digital", "recall", "compliance pressure", "device launch"],
  ...
  svc({
    ...
    relevantCompanySignals: ["device", "medtech", "mdr/ivdr", "implantable", "diagnostics", "device launch"],
  ...
  svc({
    ...
    relevantCompanySignals: ["device", "biologic", "delivery", "diabetes", "injectable", "device launch", "combination product"],
  ...
  svc({
    ...
    relevantCompanySignals: ["expansion", "emerging markets", "global", "multi-region trials"],
  ...
  svc({
    ...
    relevantCompanySignals: ["biosimilar", "device", "many markets", "expansion", "broad portfolio", "multi-region trials", "global", "post-approval"],
  ...
  svc({
    ...
    relevantCompanySignals: ["enterprise", "cost discipline", "vendor consolidation", "variable demand", "m&a", "active clinical pipeline", "large clinical pipeline"],
