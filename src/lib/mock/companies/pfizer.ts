...
export const pfizer: Company = {
  ...
  opportunity: {
    ...
    topServiceIds: ["labeling", "reg-ops", "rim", "vmo", "pv"],
    nextBestAction:
  ...
  serviceRecommendations: [
    { serviceId: "labeling", relevanceScore: 94, whyRelevant: "A portfolio this broad generates constant CCDS changes that must cascade to many local labels.", likelyBuyer: "head-of-labeling", triggerOrPainPoint: "Labeling harmonisation across markets", suggestedOpeningMessage: "We help large portfolios cut CCDS-to-local label turnaround and tighten consistency across regions.", confidence: "Inferred" },
    { serviceId: "reg-ops", relevanceScore: 92, whyRelevant: "High submission volume and acquisition integration strain operational capacity.", likelyBuyer: "director-regulatory-operations", triggerOrPainPoint: "Submission throughput at peak load", suggestedOpeningMessage: "We provide scalable regulatory operations capacity that absorbs peaks without hiring.", confidence: "Inferred" },
    { serviceId: "rim", relevanceScore: 90, whyRelevant: "M&A activity often leaves fragmented RIM data needing migration and harmonisation.", likelyBuyer: "director-regulatory-operations", triggerOrPainPoint: "RIM data fragmentation post-acquisition", suggestedOpeningMessage: "Post-acquisition RIM migration and managed operations are a core strength of ours.", confidence: "Inferred" },
    { serviceId: "pv", relevanceScore: 88, whyRelevant: "Large marketed portfolio drives high case volume and aggregate reporting load.", likelyBuyer: "head-of-pharmacovigilance", triggerOrPainPoint: "Rising PV case volume", suggestedOpeningMessage: "We scale case processing and reporting capacity with strong compliance discipline.", confidence: "Inferred" },
    { serviceId: "vmo", relevanceScore: 87, whyRelevant: "Enterprise scale and variable demand favour flexible managed-service pods.", likelyBuyer: "procurement-leader", triggerOrPainPoint: "Vendor fragmentation and variable demand", suggestedOpeningMessage: "A managed-service model consolidates fragmented spend and flexes with demand.", confidence: "Inferred" },
    { serviceId: "reg-strategy", relevanceScore: 80, whyRelevant: "Complex pipeline and combination products benefit from external strategic depth.", likelyBuyer: "vp-regulatory-affairs", triggerOrPainPoint: "Pipeline complexity", suggestedOpeningMessage: "We add strategic regulatory depth for complex filings and combination products.", confidence: "Inferred" },
    { serviceId: "ai-reg", relevanceScore: 76, whyRelevant: "Scale makes AI-assisted authoring and intelligence valuable if applied compliantly.", likelyBuyer: "cio-digital", triggerOrPainPoint: "Productivity from AI without compliance risk", suggestedOpeningMessage: "We bring validated, human-in-the-loop AI to regulatory authoring and intelligence.", confidence: "Inferred" },
  ],
