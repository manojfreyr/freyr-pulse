...
export const gilead: Company = {
  ...
  opportunity: {
    ...
    topServiceIds: ["reg-strategy", "reg-ops", "rim", "pv", "labeling"],
    nextBestAction:
  ...
  serviceRecommendations: [
    { serviceId: "reg-strategy", relevanceScore: 89, whyRelevant: "Cell therapy and new oncology modalities need experienced filing strategy.", likelyBuyer: "vp-regulatory-affairs", triggerOrPainPoint: "New-modality regulatory strategy", suggestedOpeningMessage: "We bring filing-strategy depth for cell therapy and complex oncology modalities.", confidence: "Inferred" },
    { serviceId: "reg-ops", relevanceScore: 86, whyRelevant: "Expanding oncology pipeline raises submission and operations load.", likelyBuyer: "director-regulatory-operations", triggerOrPainPoint: "Rising submission volume", suggestedOpeningMessage: "We add operations capacity as the oncology pipeline accelerates.", confidence: "Inferred" },
    { serviceId: "rim", relevanceScore: 85, whyRelevant: "Acquisitions leave RIM data to migrate and harmonise.", likelyBuyer: "director-regulatory-operations", triggerOrPainPoint: "Post-acquisition RIM harmonisation", suggestedOpeningMessage: "We migrate and run RIM after acquisitions so data stays clean.", confidence: "Inferred" },
    { serviceId: "pv", relevanceScore: 83, whyRelevant: "New oncology and cell-therapy products add complex PV obligations.", likelyBuyer: "head-of-pharmacovigilance", triggerOrPainPoint: "Complex PV for new modalities", suggestedOpeningMessage: "We scale PV for complex new-modality safety monitoring.", confidence: "Inferred" },
    { serviceId: "labeling", relevanceScore: 80, whyRelevant: "Mature virology portfolio plus new products expand labeling work.", likelyBuyer: "head-of-labeling", triggerOrPainPoint: "Labeling across mature + new portfolio", suggestedOpeningMessage: "We keep a mixed mature-and-new portfolio labeled consistently and on time.", confidence: "Inferred" },
    { serviceId: "med-writing", relevanceScore: 77, whyRelevant: "Complex filings require high-quality regulatory writing capacity.", likelyBuyer: "vp-regulatory-affairs", triggerOrPainPoint: "Authoring capacity for complex filings", suggestedOpeningMessage: "We add regulatory writing capacity for complex oncology submissions.", confidence: "Inferred" },
    { serviceId: "vmo", relevanceScore: 74, whyRelevant: "Pivot creates variable demand suited to managed pods.", likelyBuyer: "procurement-leader", triggerOrPainPoint: "Variable capacity during pivot", suggestedOpeningMessage: "Managed pods flex with the oncology pivot so you don't over-hire.", confidence: "Inferred" },
  ],
