...
export const moderna: Company = {
  ...
  opportunity: {
    ...
    topServiceIds: ["submissions", "rim", "pv", "labeling", "ai-reg"],
    nextBestAction:
  ...
  serviceRecommendations: [
    { serviceId: "submissions", relevanceScore: 90, whyRelevant: "A maturing pipeline means many concurrent global submissions for the first time.", likelyBuyer: "director-regulatory-operations", triggerOrPainPoint: "First-time multi-product submission load", suggestedOpeningMessage: "We help fast-scaling biotechs stand up submission capacity without a hiring spree.", confidence: "Inferred" },
    { serviceId: "rim", relevanceScore: 88, whyRelevant: "Scaling from one product requires a RIM backbone and clean data from the start.", likelyBuyer: "cio-digital", triggerOrPainPoint: "Building RIM for a multi-product future", suggestedOpeningMessage: "We implement and run RIM so your data scales cleanly with the pipeline.", confidence: "Inferred" },
    { serviceId: "pv", relevanceScore: 87, whyRelevant: "Each launch adds PV obligations a young commercial org must absorb.", likelyBuyer: "head-of-pharmacovigilance", triggerOrPainPoint: "Standing up scalable PV", suggestedOpeningMessage: "We build and scale PV operations as your marketed portfolio grows.", confidence: "Inferred" },
    { serviceId: "labeling", relevanceScore: 84, whyRelevant: "New products and markets create first-time global labeling needs.", likelyBuyer: "head-of-labeling", triggerOrPainPoint: "Establishing global labeling discipline", suggestedOpeningMessage: "We set up scalable global labeling so consistency is built in early.", confidence: "Inferred" },
    { serviceId: "ai-reg", relevanceScore: 82, whyRelevant: "An innovation-led culture is receptive to AI-assisted authoring and intelligence.", likelyBuyer: "cio-digital", triggerOrPainPoint: "Doing more with a lean team", suggestedOpeningMessage: "We bring validated AI to authoring and intelligence so a lean team moves faster.", confidence: "Inferred" },
    { serviceId: "reg-strategy", relevanceScore: 79, whyRelevant: "New modalities and indications need experienced filing strategy.", likelyBuyer: "vp-regulatory-affairs", triggerOrPainPoint: "Novel-modality filing strategy", suggestedOpeningMessage: "We add filing strategy depth for novel modalities and global expansion.", confidence: "Inferred" },
    { serviceId: "vmo", relevanceScore: 76, whyRelevant: "Variable, fast-growing demand suits a flexible managed-service model.", likelyBuyer: "procurement-leader", triggerOrPainPoint: "Scaling capacity flexibly", suggestedOpeningMessage: "A managed-service pod flexes with your pipeline so you don't over-hire.", confidence: "Inferred" },
  ],
