...
/** Master entity: high-level service type/discipline. Services reference these by id. */
export interface ServiceType {
  ...
  status: EntityStatus;
  displayOrder: number;
  /** Stamped on upsert; surfaced to admin UIs. */
  updatedAt?: string;
}
...
export interface SalesAsset {
  ...
  status: AssetStatus;
  tags: string[];
  /** Optional targeting — persona ids or stakeholder-group labels. Additive; unused in 2.0-A. */
  audienceTags?: string[];
