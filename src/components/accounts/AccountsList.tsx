          ...
          <div className="spread" style={{ flexWrap: "wrap", gap: 14 }}>
            <div style={{ minWidth: 0 }}>
              <div className="row" style={{ gap: 10, flexWrap: "wrap" }}>
                <Link href={`/accounts/${a.companyId}/`} className="strong" style={{ fontSize: 16, color: "var(--ink)" }}>{a.companyName}</Link>
            ...
            <div className="row" style={{ gap: 8 }}>
              <Link href={`/accounts/${a.companyId}/`} className="btn btn-sm">Open</Link>
