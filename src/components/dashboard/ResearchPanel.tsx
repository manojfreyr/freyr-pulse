...
const SOURCE_LABEL: Record<string, string> = { sec: "SEC EDGAR", website: "Company website" };

export function ResearchPanel({ company, onResearched }: { company: Company; onResearched: (c: Company) => void }) {
      ...
      <div className="spread" style={{ gap: 16, flexWrap: "wrap" }}>
        <div style={{ minWidth: 0 }}>
          ...
          <p className="small soft" style={{ margin: 0, maxWidth: 640 }}>
            Pulls live signals from <span className="strong">SEC EDGAR</span> (US public filers) and the
