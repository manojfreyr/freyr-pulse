...
export const metadata: Metadata = {
  title: "Freyr Pulse — Sales Intelligence",
  description: "Enterprise sales intelligence and account planning for life-sciences regulatory services.",
};
        ...
        <SavedAccountsProvider>
          ...
          <footer style={{ borderTop: "1px solid var(--line)", background: "var(--surface)" }}>
            <div className="container" style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: 10 }}>
              <span className="tiny muted">Freyr Pulse · Phase 1 (MVP). Demo intelligence — mock data, for demonstration only.</span>
