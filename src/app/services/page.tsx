...
export default function ServicesPage() {
  ...
  function handleSave(service: FreyrService) {
    ...
    setEditing(null);
    api.saveService(service).then(() => api.getCatalog()).then(setCatalog).catch(() => {});
  }
  function handleDelete(id: string) {
    ...
    api.deleteService(id).catch(() => api.getCatalog().then(setCatalog).catch(() => {}));
  }
  function handleToggle(id: string) {
    ...
    api.saveService(next).catch(() => api.getCatalog().then(setCatalog).catch(() => {}));
  }
